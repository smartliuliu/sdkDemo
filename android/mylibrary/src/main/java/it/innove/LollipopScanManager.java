...
public class LollipopScanManager extends ScanManager {
    ...
    public void scan(ReadableArray serviceUUIDs, final int scanSeconds, ReadableMap options,  Callback callback) {
        Log.d("sdkDemo","========== [LollipopScanManager] ========="+serviceUUIDs);
        ...
        Log.d("sdkDemo","============ [LollipopScanManager] ========= filters = "+filters+"      build = "+scanSettingsBuilder.build()+"   callback = "+mScanCallback);
	...
	private ScanCallback mScanCallback = new ScanCallback() {
		...
		public void onScanResult(final int callbackType, final ScanResult result) {
            Log.d("sdkDemo","============== [ScanCallback] ========== "+callbackType+"    ====  result = "+result);
			runOnUiThread(new Runnable() {
				@Override
				public void run() {
					Log.i(bleManager.LOG_TAG, "DiscoverPeripheral: " + result.getDevice().getName());
                    Log.d("sdkDemo","============= DiscoverPeripheral: "+result.getDevice().getName());
